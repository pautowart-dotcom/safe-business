...
// 05.08.2026: раздел "Журналы" заморожен целиком, включая "Печатные бланки"
// (это уже бумажный журнал, но решили заморозить и его — см. хендофф).
// GET /verify/:token ВЫШЕ этого блока и не трогается — уже выданные
// физические бланки с QR должны проверяться и дальше, пока существуют,
// это не про генерацию новых. Ниже — только создание/список новых бланков.
