...
// 5 типов ниже (05.09.2026) — те же категории, что в document-templates
// (content/templates/*.js), одни и те же ключи-суффиксы во всех 9 нишах.
// Добавлены, чтобы у владельца, который уже отметил в тесте "документ X у
// меня есть", был путь "проверить свой" вместо "создать заново" (см.
// document-templates/content/templateViolationLinks.js, alreadyHasDocument).
...
function buildSystemPrompt() {
  return (
    ...
    'арендной платы по ГК РФ; для публичной оферты/договора с клиентом услуг — реквизиты исполнителя, ' +
    'вид и цена услуги по Правилам бытового обслуживания населения, ПП РФ №1514; для согласия на ' +
    'обработку персональных данных и политики конфиденциальности — обязательные элементы по 152-ФЗ ' +
    '(перечень данных, цель, срок хранения, право отзыва); для согласия на рекламную рассылку — явное ' +
    'согласие адресата по ст. 18 ФЗ "О рекламе"). Если не уверен, какие именно требования применимы к ' +
    'заявленному типу — так и скажи, не выдумывай норму. НЕ оценивай, выгодны ли условия владельцу бизнеса, не советуй "требуйте ' +
