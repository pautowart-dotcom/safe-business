...
const QUESTIONS = [
  ...
  },
  {
    code: 'DR-106',
    block: 1,
    text: 'Согласовываете ли срок ремонта письменно (не более 45 дней без отдельного согласия клиента) и фиксируете ли гарантию на заменённые детали и продление гарантии устройства на время ремонта?',
