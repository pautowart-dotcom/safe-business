...
const QUESTIONS = [
  ...
  },
  {
    code: 'MN-801',
    block: 8,
    text: 'Подписывает ли клиент отдельное информированное согласие на саму процедуру (риски пореза/инфицирования, аллергии на гель-лак/акрил) — помимо согласия на обработку персональных данных?',
    hint: null,
    showIf: null,
    answers: [
      { label: 'Да', points: 1 },
