...
const SEGMENTS = [
  ...
  },
  {
    ...
    hasNicheStep: true,
    // Один узкий ниша-пункт на старте (10.09.2026, решение владельца, по
    // тому же образцу, что клининг/общепит/розница) — ремонт обуви,
    // фотостудии, химчистки — другие типичные "бытовые услуги" по
    // классификации Правил бытового обслуживания населения (ПП РФ №1514) —
    // сознательно отложены на отдельный заход, см. комментарий в начале
