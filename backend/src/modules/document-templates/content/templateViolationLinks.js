...
const NICHE_PREFIX = {
  ...
  pilates: 'PL',
  // martial_arts (09.09.2026) — та же нумерация 402-406, тот же паттерн.
  martial_arts: 'MT',
  // atelier (10.09.2026, новый сегмент "Бытовые услуги") — та же нумерация
  ...
  photo_studio: 'PH',
  // dry_cleaning (10.09.2026) — та же нумерация 402-406, тот же паттерн.
  dry_cleaning: 'DC',
  // pet_grooming (12.09.2026) — та же нумерация 402-406, тот же паттерн.
  pet_grooming: 'GR',
  // pet_boarding (14.09.2026) — та же нумерация 402-406, тот же паттерн.
  pet_boarding: 'PB',
  ...
  // car_wash (14.09.2026) — та же нумерация 402-406, тот же паттерн.
  car_wash: 'CW',
};
...
const OFERTA_NICHES = ['manicure', 'lashes_brows', 'hair', 'massage', 'tattoo', 'depilation', 'solarium', 'barbershop', 'fitness_gym', 'dance', 'yoga', 'pilates', 'martial_arts', 'atelier', 'shoe_repair', 'photo_studio', 'dry_cleaning', 'pet_grooming', 'pet_boarding', 'appliance_repair', 'watch_jewelry_repair', 'car_wash'];
