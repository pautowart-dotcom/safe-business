...
function SecuritySection() {
  return (
    <Card>
      ...
      <div style={{ fontSize: 13, fontWeight: 700, margin: '14px 0 4px' }}>Шаблоны документов</div>
      <p style={{ fontSize: 13, color: C.secondary, margin: 0 }}>
        Готовые документы под вашу нишу (оферта, согласия на обработку персональных данных и т.д.), заполненные данными вашей компании — сервис сам подбирает, какие вам нужны, вы просто заполняете реквизиты и скачиваете PDF. Разовая оплата — доступ навсегда, не подписка. Часть шаблонов помечена «бета» — юрист их ещё дорабатывает, это не готовая юридическая консультация, а рабочий черновик.
      </p>
      <Mock>
        ...
        <MockButton>Заполнить и сгенерировать</MockButton>
      </Mock>
