  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 12, color: C.subtle, marginBottom: 16, lineHeight: 1.5 }}>
        ...
        инструктаж и т.д.).{isManagement && ' Вкладка "Печатные бланки" — это другое: готовый PDF с уникальным QR-кодом для официального бумажного журнала на печать. QR на нём — только для проверки инспектором на отдельной странице, в приложение он не ведёт и никого не логинит.'}
      </div>
