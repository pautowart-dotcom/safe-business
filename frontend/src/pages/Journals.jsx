...
export default function Journals() {
  ...
  return (
    <div>
      <div style={{ fontSize: 20, fontWeight: 800, marginBottom: 6 }}>Журналы</div>
      <div style={{ fontSize: 12, color: C.subtle, marginBottom: 16, lineHeight: 1.5 }}>
        Здесь ведутся электронные записи по датам — вкладки ниже соответствуют
        отдельным журналам (кто включал УФ-лампу, кто кому проводил
        инструктаж и т.д.). Вкладка "Дезсредства" вручную не заполняется —
        она сама собирается из склада: отметьте расходник как "Дезинфицирующее
        средство" в разделе "Склад расходников", и каждый приход/списание
        этой позиции попадёт сюда автоматически.
        {isManagement && ' Вкладка "Печатные бланки" — это другое: готовый PDF с уникальным QR-кодом для официального бумажного журнала на печать. QR на нём — только для проверки инспектором на отдельной странице, в приложение он не ведёт и никого не логинит.'}
      </div>
