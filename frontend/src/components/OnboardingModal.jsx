...
const SLIDES_BY_ROLE = {
  owner: [
    ...
    },
    {
      ...
      text: 'В разделе "Ещё" — печатные журналы с QR-кодом (стерилизация, дезсредства и т.д.), приглашение мастеров и администраторов, дедлайны и обратная связь от команды. Эту инструкцию можно открыть заново там же в любой момент.',
    },
  ],
  admin: [
    COMMON_SLIDE,
