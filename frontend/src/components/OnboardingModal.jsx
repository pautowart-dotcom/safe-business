...
const SLIDES_BY_ROLE = {
  owner: [
    ...
    },
    {
      icon: 'settings',
      title: 'Подписка',
      text: 'В "Настройках" — оплата подписки на платформу и данные компании. Эту инструкцию можно открыть заново в любой момент через "Ещё" → "Как пользоваться", а более подробная справка с примерами экранов — там же, "Подробная справка".',
    },
  ],
  admin: [
    COMMON_SLIDE,
    ...
    },
    {
      icon: 'team',
      title: 'Команда',
      text: 'Вы можете приглашать Мастеров и следить за дедлайнами компании. Раздел "Безопасность" и настройки подписки — только у владельца. Эту инструкцию можно открыть заново через "Ещё" → "Как пользоваться", а более подробная справка с примерами экранов — там же, "Подробная справка".',
    },
  ],
  master: [
    COMMON_SLIDE,
