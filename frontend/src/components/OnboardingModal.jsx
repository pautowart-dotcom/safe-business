...
const SLIDES_BY_ROLE = {
  owner: [
    ...
    },
    {
      icon: 'doc',
      title: 'Команда',
      text: 'В разделе "Ещё" — приглашение мастеров и администраторов, дедлайны и обратная связь от команды. Эту инструкцию можно открыть заново там же в любой момент.',
    },
  ],
  admin: [
    COMMON_SLIDE,
    ...
    },
    {
      icon: 'team',
      title: 'Команда',
      text: 'Вы можете приглашать Мастеров и следить за дедлайнами компании. Раздел "Безопасность" и настройки подписки — только у владельца.',
    },
  ],
  master: [
    COMMON_SLIDE,
