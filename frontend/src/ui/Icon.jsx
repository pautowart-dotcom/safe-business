...
const P = {
  ...
  // "Искра"/sparkle — для ИИ-ассистента (20.08.2026, владелец попросил не
  // типовую иконку чата) — четырёхконечная звезда с вогнутыми сторонами,
  // тот же символ, что уже стал общепринятым для "ИИ" в интерфейсах.
  // Основная звезда + маленький акцент — тот же приём, что у большинства
  // таких иконок (не одна ровная звезда, а главная + "отблеск").
