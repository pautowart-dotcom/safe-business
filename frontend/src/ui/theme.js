...
// Manrope (24.08.2026, владелец: тот же шрифт, что уже на лендинге, не
// системный) — подключён в index.html (Google Fonts), тот же fallback-
// хвост, что был раньше, на случай если шрифт ещё не догрузился.
export const F = "'Manrope',-apple-system,'SF Pro Text','Segoe UI',sans-serif";
