...
export const NICHE_OPTIONS = [
  ...
  ['watch_jewelry_repair', 'Ремонт часов и ювелирных изделий', 'household'],
  // device_repair (15.09.2026) — седьмая ниша сегмента "Бытовые услуги".
  ['device_repair', 'Ремонт компьютеров и телефонов', 'household'],
  // car_wash (14.09.2026) — первая ниша нового сегмента "Услуги для автомобилей".
  ['car_wash', 'Автомойка', 'auto'],
  // tire_service (15.09.2026) — вторая ниша сегмента "Услуги для автомобилей".
  ['tire_service', 'Шиномонтаж', 'auto'],
  // auto_service (15.09.2026) — третья ниша сегмента "Услуги для автомобилей".
  ['auto_service', 'Автосервис (ремонт и ТО)', 'auto'],
  // kids_club (15.09.2026) — первая ниша нового сегмента "Услуги для детей".
  ['kids_club', 'Детские клубы и секции', 'kids'],
  // facade_cleaning (15.09.2026) — вторая ниша сегмента "Клининг".
